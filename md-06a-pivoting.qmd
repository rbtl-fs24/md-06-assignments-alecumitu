...
2.  What's the `tidyverse` Package? Describe in maximum two sentences below.
    ...
    It includes core packages like ggplot2, dplyr, tidyr, readr, purrr, tibble, stringr, and forcats
...
1.  Starting with the `waste_data_long_mean` object, execute the code and observe the output in the Console. Would you publish this table in this format in a report? No
...
2.  Execute the code and observe the output in the Console. Would you publish this table in a report in this format? Yes
